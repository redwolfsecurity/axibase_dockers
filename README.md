...
For each of imported files, substitution of environment variables will be performed. Placeholders should have '${ENV.ENV_NAME}' format, where `ENV_NAME` is the name of environment varaiable.
